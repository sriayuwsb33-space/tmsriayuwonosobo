  ...
  return (
    <div className="p-4">
      <div className="flex gap-4 mb-6">
        <button onClick={() => setPage("shop")} className="bg-black text-white px-3 py-1">
          Shop
        </button>
        <button onClick={() => setPage("admin")} className="bg-gray-700 text-white px-3 py-1">
          Admin
        </button>
      </div>
...
function Shop() {
  ...
  const loadProducts = async () => {
    ...
    // AUTO ISI 10 PRODUK JIKA KOSONG
    if (data.length === 0) {
      const sample = [
  ...
  return (
    <div>
      <h1 className="text-xl font-bold mb-4">Toko Mas Sri Ayu</h1>
      ...
      {orders.map(o => (
        <div key={o.id} className="border p-2 mt-2">
          ...
          <button
            ...
            className="bg-yellow-500 px-2 mr-1"
          >
            Proses
          </button>
